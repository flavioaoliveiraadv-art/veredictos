...
const TasksPage: React.FC<TasksPageProps> = ({
  ...
  const getTypeStyle = (tipo: TipoPrazo) => {
    switch (tipo) {
      ...
      case TipoPrazo.REUNIAO: return 'bg-indigo-50 text-indigo-600 border-indigo-100';
      case TipoPrazo.ATENDIMENTO: return 'bg-emerald-50 text-emerald-600 border-emerald-100';
      case TipoPrazo.ADMINISTRATIVO: return 'bg-gray-50 text-gray-600 border-gray-100';
